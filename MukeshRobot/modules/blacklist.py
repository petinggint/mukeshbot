    ...
    for text in split_text:
        if filter_list == "ɴɪʜ ᴍᴇᴋ ᴅᴀғᴛᴀʀ ʙʟ sᴇᴋᴀʀᴀɴɢ <b>{}</b>:\n".format(
            ...
            send_message(
                ...
                "ɢᴀ ᴀᴅᴀ ᴅᴀғᴛᴀʀ ʙʟ ɴʏᴀ ᴅɪ <b>{}</b>!".format(html.escape(chat_name)),
...
ADD_BLACKLIST_HANDLER = CommandHandler("bl", run_async=True)
UNBLACKLIST_HANDLER = CommandHandler("unbl", run_async=True)
